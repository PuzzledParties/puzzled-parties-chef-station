...
|---|---|---|---|
| Master power and network, including Master Controller ESP32 | [Open diagram](../hardware/fritzing/master-power-network/chef_station_master_power_network_layout.png) | [Open checklist](../hardware/fritzing/master-power-network/master_power_network_tables_and_checklist.md) | [Open Fritzing file](../hardware/fritzing/master-power-network/chef_station_master_power_network_editable.fzz) |
